...
class MSDSTModel(nn.Module):
    def __init__(self, features, sparse_embedding_dim=4,
        ...
        super(MSDSTModel, self).__init__(**kwargs)
        ...
        output_dim = 3
        self.p_dnn = DNN([self.hidden_dim, 1])
    ...
    def forward(self, batch):
        ...
        p = torch.squeeze(self.p_dnn(flatten_hidden))
        v = torch.squeeze(torch.relu(self.v_dnn(flatten_hidden)))
